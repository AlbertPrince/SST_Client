    ...
    <div className="min-h-screen bg-[#FDF3DC] pt-32 pb-20 px-6 flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-3xl shadow-sm p-8 border border-[#3B1A00]/10">
        <div className="text-center mb-8">
          <h1 className="text-3xl font-serif font-bold text-[#3B1A00] mb-2">Create an Account</h1>
          <p className="text-[#3B1A00]/70">Save your taste profile and order history.</p>
        </div>
        ...
        <div className="mt-8 text-center text-sm text-[#3B1A00]/70">
          ...
          <Link to="/auth/login" className="text-[#C97D0A] font-bold hover:underline">
            Sign In
          </Link>
        </div>
      </div>
